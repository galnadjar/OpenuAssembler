...
/*parses throguh the line of input looking for a label, if proper label sets the label variable and
 * returns its ending index+1,
 * otherwise return -1*/
...
/*this function checks if a valid label or instruction ,
