...
#define ERROR_EMPTY_LABEL(X) printf("ERROR: In line %d, an empty label was found\n",X)
...
#define ERROR_REPEATED_LABEL_ASSIGNS(X,Y) printf("ERROR: In line %d, the label \"%s\" requested to reassign with the same data\n",X,Y)
#define ERROR_ENTRY_PLACEMENT(X) printf("WARNING: In line %d,a \".entry\" was entered after a label\n",X)
#define ERROR_EXTERN_PLACEMENT(X) printf("ERROR: In line %d,a \".extern\" was entered after a label\n",X)
...
#define ERROR_EXTRANEOUS_OPERAND(X) printf("ERROR: In line %d,extraneous operand was found\n",X)

#define ERROR_ARGS_AMOUNT(X,Y,Z) printf("ERROR: In line %d, %d arguments were needed, %d was given.\n",X,Y,Z)
...
#define ERROR_REPEATED_ARIT_OPS(X) printf("ERROR: In line %d,repeated arithmetic signs were given\n",X)
